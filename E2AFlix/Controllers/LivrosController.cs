...
namespace E2AFlix.Controllers
{
    public class LivrosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Descricao,Nota,FotoLivro")] Livros livros)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descricao,Nota,FotoLivro")] Livros livros)
        {
            if (id != livros.Id)
            {
                return NotFound();
